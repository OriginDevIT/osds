 ...
 *
 * `listing.upsert` is the first slice. The entitlement command handler is
 * re-exported here rather than from the root for the same reason; claim command
 * persistence lands in a later pass.
 */
export {
